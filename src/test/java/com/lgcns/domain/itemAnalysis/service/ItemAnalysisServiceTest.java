...
//    @Autowired
//    private ItemSalesStatsRepository itemSalesStatsRepository;
//    @Autowired
...
//
//        // 실제 서비스에 Mock 객체 주입
//        itemAnalysisService = new ItemAnalysisServiceImpl(
//                dynamoDBRepository,
...
//        );
//
//        ownerManager = managerRepository.save(Manager.createManager("testManager1",
// "testPassword"));
//        otherManager = managerRepository.save(Manager.createManager("otherManager",
// "testPassword"));
//
...
//        item2 = Item.createItem(popup, "제니 포토카드", "https://bucket/jennie.jpg", 15000, 100, 10,
// "a2");
//        item3 = Item.createItem(popup, "로제 포토카드", "https://bucket/rose.jpg", 15000, 100, 10,
// "b1");
//
...
//
//        itemSalesStatsRepository.save(ItemSalesStats.createItemSalesStats(popup.getId(),
// item1.getId(), 50));
//        itemSalesStatsRepository.save(ItemSalesStats.createItemSalesStats(popup.getId(),
// item2.getId(), 30));
//        itemSalesStatsRepository.save(ItemSalesStats.createItemSalesStats(popup.getId(),
...
//            assertThat(trendingItems).hasSameClassAs(3);
//
//            // 예상 순서: item1(인기도 40 + 판매량 50), item2(인기도 30 + 판매량 30), item3(인기도 20 + 판매량 20)
...
//        event1.setEventKey("2025-01-10T12:00:00Z#click");
...
//        event2.setEventKey("2025-01-10T13:00:00Z#view");
...
//        event3.setEventKey("2025-01-10T14:00:00Z#click");
...
//        event4.setEventKey("2025-01-10T15:00:00Z#view");
